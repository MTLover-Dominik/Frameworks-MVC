...
export const emailRequirements = document.getElementById('emailRequirementResult');
...
export const showPassword = document.getElementById('passwordShowPassword');
export const showPasswordIcon = document.getElementById('showPassword');
export const showConfirm = document.getElementById('confirmShowPassword');
